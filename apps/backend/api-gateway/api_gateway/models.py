...
class SensorReading(BaseModel):
    ...
    event_id: str = Field(str(uuid4()), description="Unique Event UUID")
    ...
    temperature: float = Field(
        ..., ge=-50, le=150, description="Temperature in Celsius", examples=[24.5]
    )
    humidity: float = Field(
        ..., ge=0, le=100, description="Relative humidity percentage", examples=[61.2]
    )
